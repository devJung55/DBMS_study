...
VALUES(SEQ_USER.NEXTVAL, 'hds1234', '한동석', '1234', '01012341234', 'hds1234@gmail.com', '경기도 남양주시', 'jjy');

SELECT COUNT(USER_ID) FROM TBL_USER;

SELECT * FROM TBL_USER;

SELECT COUNT(USER_IDENTIFICATION) FROM TBL_USER WHERE USER_RECOMMENDER_ID = 'jjy';
